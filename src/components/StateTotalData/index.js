...
class StateTotalData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/dwfrejyxl/image/upload/v1651046450/Group_pxbmk5.png',
    ...
    const activeData = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/dwfrejyxl/image/upload/v1651046572/protection_1_aiyssf.png',
      value: totalActive,
    }
    ...
    const recoveredData = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/dwfrejyxl/image/upload/v1651046749/Vector_4_ehfyhe.png',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/dwfrejyxl/image/upload/v1651046950/Outline_oal5ph.png',
      value: totalDeceased,
    }
