    ...
    return (
      <>
        <div testid="countryWideConfirmedCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dwfrejyxl/image/upload/v1651046450/Group_pxbmk5.png"
        ...
        <div testid="countryWideActiveCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dwfrejyxl/image/upload/v1651046572/protection_1_aiyssf.png"
            className="stats-icon"
        ...
        <div testid="countryWideRecoveredCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dwfrejyxl/image/upload/v1651046749/Vector_4_ehfyhe.png"
            className="stats-icon"
        ...
        <div testid="countryWideDeceasedCases" className="stats-block-column ">
          ...
          <img
            src="https://res.cloudinary.com/dwfrejyxl/image/upload/v1651046950/Outline_oal5ph.png"
            className="stats-icon"
